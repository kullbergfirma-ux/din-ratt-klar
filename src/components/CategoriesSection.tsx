...
const CategoriesSection = () => (
  <section id="kategorier" aria-label="Ärendekategorier" className="py-20 sm:py-28 bg-background">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {categories.map((cat, i) => (
          ...
          >
            <Link
              to={`/${cat.slug}`}
              className="card-interactive p-6 text-left flex flex-col gap-2 group block h-full"
            >
